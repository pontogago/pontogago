...
'''
def pecanova(): #gera a peça e posição aleatoria
    ...
    if intervalo == 1:
        imprimir(poslinha[(intervalolinha)])
        
    elif intervalo == 2:
        imprimir(posquadrado[0])
        
    elif intervalo == 3:
        imprimir(posl[(intervalol)])
        
    elif intervalo == 4:
        imprimir(poslinv[(intervalolinv)])
        
    elif intervalo == 5:
        imprimir(poszigzag[(intervalozigzag)])
        
    elif intervalo == 6:
        imprimir(poszigzaginv[(intervalozigzaginv)])

    elif intervalo == 7:
        imprimir(postreta[(intervalotreta)])
'''
'''
for i in range(30):
    pecanova()
